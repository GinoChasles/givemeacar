  ...
  return <>
    ...
    <Admin dataProvider={dataProvider} i18nProvider={i18nProvider}>
      ...
      <Resource icon={Palette} options={{ label: t("custom.colors") }} name="colors"
        list={DisplayColor} edit={EditColor} create={CreateColor} />
      ...
      <Resource icon={Explore} options={{ label: t("custom.departments") }} name="departments"
        list={DisplayDepartment} show={ShowGuesser} edit={EditDepartment} create={CreateDepartment} />

      <Resource icon={SupervisorAccount} options={{ label: t("custom.managers") }} name="managers"
        list={DisplayManager} show={ShowGuesser} edit={EditManager} create={CreateManager} />

      <Resource icon={Face} options={{ label: t("custom.clients") }} name="clients"
        list={DisplayClient} show={ShowGuesser} edit={EditClient} create={CreateClient} />
      ...
      <Resource icon={AirportShuttle} options={{ label: t("custom.models") }} name="models"
        list={DisplayModel} show={ShowGuesser} edit={EditModel} create={CreateModel} />
      ...
      <Resource icon={Description} options={{ label: t("custom.rents") }} name="rents"
        list={DisplayRent} show={ShowGuesser} edit={EditRent} create={CreateRent} />

      <Resource icon={EvStation} options={{ label: t("custom.energyTypes") }} name="energy_types"
        list={DisplayEnergyType} show={ShowGuesser} edit={EditEnergyType} create={CreateEnergyType} />

      <Resource icon={Explore} options={{ label: t("custom.regions") }} name="regions"
        list={DisplayRegion} show={ShowGuesser} edit={EditRegion} create={CreateRegion} />
      ...
      <Resource icon={Public} options={{ label: t("custom.countries") }} name="countries"
        list={DisplayCountry} show={ShowGuesser} edit={EditCountry} create={CreateCountry} />
