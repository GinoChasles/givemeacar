...
public class ModelController {
    ...
    public ResponseEntity<Model> findById(@PathVariable int id) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        Optional<Model> model = service.findById(TableNames.models,id);
        if (model.isPresent()) {
