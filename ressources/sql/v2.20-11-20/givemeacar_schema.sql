...
CREATE TABLE `address` (
  ...
  `localities` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `city` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(68) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `city` VALUES (1,'nantes','44000');
...
CREATE TABLE `country` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(42) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_UNIQUE` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `credit_card` (
  ...
  `society` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `street` VALUES (1,'de mon cul');
...
INSERT INTO `street_has_city` VALUES (1,1);
...
INSERT INTO `street_type` VALUES (1,'rue');
...
-- Dump completed on 2020-11-20 17:24:20
